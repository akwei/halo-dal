...
public class DALPreparedStatement implements PreparedStatement {
    ...
    private void prepare() throws SQLException {
        ...
        DALFactory dalService = DALFactory.getInstance();
        SQLInfo sqlInfo = dalService.getSqlAnalyzer().analyse(sql,
                values.toArray(new Object[values.size()]));
        String[] tables = sqlInfo.getTables();
        DALPartitionParser parser;
        DALPartitionTableInfo[] infos = new DALPartitionTableInfo[tables.length];
        int i = 0;
        for (String table : tables) {
            parser = dalService.getDalPartitionParserFactory().getParser(table);
        ...
        this.sql = dalService.getSqlAnalyzer().outPutSQL(sqlInfo);
